...
<html>
  ...
  <body>
    <div align="center" >
		<form action="tea_updatePass.action" method="post" name="form1" onSubmit="return myCheck()"
			...
			<table width="470"  cellpadding="1" align="center" >
				<tr>
					...
					<td width="320"><input class="form-control" type="password" name="teacher.TPassword" />
				</tr>
				<tr>
